...
public class MessagesAPI {
    private MutableLiveData<List<Message>> messagesListData = new MutableLiveData<>(new ArrayList<>());
    private final ContactDao contactDao;
    Retrofit retrofit = RetrofitSingleton.getInstance();
    WebServiceAPI webServiceAPI;

    public MessagesAPI(MutableLiveData<List<Message>> messagesListData, ContactDao contactDao) {
